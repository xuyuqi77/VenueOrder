...
<body>
	...
	<div class="main_content">
		...
		<div class="content_right">
			<table cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td style="background-color:#FAFBFD;">
						<iframe name="mainFrame" id="mainFrame" frameborder="0" src="default" style="width:100%;height:100%;"></iframe>
					</td>
			...
			<div class="sys_bottom"> Copyright &copy; 2017 场馆预定系统后台</div>
		</div>
	</div>
